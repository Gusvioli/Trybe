...
// 1.3. Resposta: Porque a class tech recebe um style de move o conteudo no exo y -20px
...
input.addEventListener('keyup', textoDigitado);

function textoDigitado() {
  classeTech.innerHTML = input.value;
}
...
function redirecionar() {
  window.location.href = "https://github.com/Gusvioli";// Muda o local o Windows
}
