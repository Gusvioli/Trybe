...
getUser(userFullName, 5); // deve imprimir "Hello! My name is Ivan Ivanovich" depois de um certo tempo
getUser(userNationality, 5); // deve imprimir "Ivan is Russian" depois de um certo tempo