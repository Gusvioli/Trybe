...
#####Bloco 03: Introdução à HTML e CSS
    ...
    - [x]04: HTML Semântico
    - [x]05: [Projeto - Lessons]('sd-022-b-project-lessons-learned')
...
#####Bloco 04: Introdução à JavaScript e Lógica de Programação
    ...
    - [x]05: [Projeto - Playground Functions]('sd-022-b-project-playground-functions')
...
#####Bloco 05: JavaScript: DOM, Eventos e Web Storage
    ...
    - [x]05: [Projeto - Arte com Pixels]('sd-022-b-project-pixels-art')
    - [x]06: [(Bônus) Projeto - Lista de tarefas]('sd-022-b-project-todo-list')
    - [x]07: [(Bônus) Projeto - Meme Generator]('sd-022-b-project-meme-generator')
    - [x]07: [(Bônus) Projeto - Adivinhe a Cor]('sd-022-b-project-guess-color')
    - [x]07: [(Bônus) Projeto - Carta Misteriosa]('sd-022-b-project-mistery-card')
...
#####Bloco 06: HTML e CSS: Forms, Flexbox e Responsivo
    ...
    - [x]06: [Projeto - Trybewarts]('sd-022-b-project-trybewarts')
...
#####Bloco 07: Introdução à JavaScript ES6 e Testes Unitários
    ...
    - [x]04: [Projeto - JavaScript Testes Unitários]('sd-022-b-project-unit-tests')
...
#####Bloco 08: Higher Order Functions do JavaScript ES6
    ...
    - [x]06: [Projeto - Zoo functions]('sd-022-b-project-zoo-functions')
