const { averageAge, books } = require('./exercise3');
...
describe('Teste da função averageAge Exercício 3', ()=>{ 
    ...
    test('Teste 4: verificar se a saida retorna 43', ()=>{
      expect(averageAge(books)).toEqual(43);
    })
  });