const { longestNamedBook, books } = require('./exercise4');
const array = [{
    id: 1,
...
describe('Teste da função averageAge Exercício 4', ()=>{ 
    ...
    test('Teste 4: verificar se a saida retorna {nArray}', ()=>{
      expect(longestNamedBook(books)).toEqual(nArray);
    })
  });