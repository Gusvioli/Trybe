...
// abaixo, onde cada objeto terá o formato { name: nome do aluno, average: media das notas }. 
...
function studentAverage(student, grade) {
  ...
  return student
    .map((item, index) => ({name: item, average: parseFloat(grade
...
module.exports = { studentAverage, students, grades, expected }; 