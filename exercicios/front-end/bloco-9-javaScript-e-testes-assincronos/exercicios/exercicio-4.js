...
imprimeMsgTemperatura = (temperatura) => console.log(`Mars temperature is ${temperatura} egree Celsius`);
setTimeout(() => imprimeMsgTemperatura(getMarsTemperature()), messageDelay());
